...
\begin{frame}
    ...
    \begin{itemize}
        ...
        %    \end{itemize}
        \pause
        \item notebook UIs \structure{not embeddable} in third--party web sites
            \begin{itemize}
                \pause
                \item no way to use a notebook embedded in your web site
            \end{itemize}
        \pause
        \item \structure{no well defined APIs} for developers
            \begin{itemize}
                \pause
...
\begin{frame}
    ...
    There is a very long \structure{TODO} list, but:
    \begin{itemize}
        \pause
        \item the ultimate goal it to run programs like \structure{Agros2D} in a web browser
            \begin{itemize}
                \pause
                \item we may need to develop a scientific \structure{toolkit for the web}
                \pause
                \item a toolkit similar to Enthought \texttt{traits}
            \end{itemize}
        \pause
        \item currently we use \structure{JavaScript} for Online Lab's desktop
            \begin{itemize}
                \pause
                \item this is fine on the initial stage of development
                \pause
                \item in future we may use \structure{Python}, via \texttt{py2js} program
            \end{itemize}
    \end{itemize}
\end{frame}
